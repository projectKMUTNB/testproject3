...
<body>
 ...
 $(function(){
     ...
     var formCheckStatus = function(obj,status){
      ...
      <div id="companyAdd" class="modal fade" role="dialog">
                          ...
                          <div class="col-md-12">
                              <div class="card">
                                <div class="card-header" data-background-color="red">
                                    <h4 class="title">เพิ่มข้อมูลสถานประกอบการ</h4>
                                    <p class="category">เพิ่มข้อมูลสถานประกอบการที่นักศึกษาฝึกงานอยู่</p>
                                </div>
                                        <div class="col-lg-12">
                                            <form role="form" id="form" name="form" method="post" action="addcompanysecondaryQuery.php">
                                              <div class="form-group label-floating has-feedback">
                                                <label class="control-label">ชื่อสถานประกอบการ</label>
                                                <input type="text" name="company_name" class="form-control css-require">
                                              </div>
                                              <div class="form-group label-floating has-feedback">
                                                  <label class="control-label">ที่อยู่สถานประกอบการ</label>
                                                  <textarea class="form-control css-require" name="company_address" rows="4"></textarea>
                                              </div>
                                              <div class="form-group label-floating has-feedback">
                                                <label class="control-label">Email สถานประกอบการ</label>
                                                <input type="text" name="company_email" class="form-control css-require">
                                              </div>
                                              <div class="form-group label-floating has-feedback">
                                                <label class="control-label">เบอร์โทรศัพท์สถานประกอบการ</label>
                                                <input type="number" name="company_tel" class="form-control css-require">
                                              </div>
