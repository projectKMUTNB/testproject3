...
<body>
 ...
 $(function(){
     ...
     var formCheckStatus = function(obj,status){
      ...
      <div id="travelexpenseAdd" class="modal fade" role="dialog">
                          ...
                          <div class="col-md-12">
                              <div class="card">
                                <div class="card-header" data-background-color="red">
                                    <h4 class="title">เพิ่มข้อมูลค่าเดินทาง</h4>
                                </div>
                                        <div class="col-lg-12">
                                            <form role="form" id="form1" name="form1" method="post" action="addtravelexpenseQuery.php">
                                              <div class="form-group label-floating has-feedback">
                                                <label class="control-label">ใส่จำนวนค่าเดินทาง บาท/กิโลเมตร</label>
                                                <input type="number" name="te_bath" class="form-control css-require">
                                              </div>
