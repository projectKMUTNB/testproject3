...
<head>
  ...
  <title>ผลการแก้ไขข้อมูลหัวข้อรองสำหรับนักศึกษาประเมินสถานประกอบการ &mdash; ระบบประเมินผลและติดตามการนิเทศงานนักศึกษา</title>
...
$mrsc_id = $_POST['e'];
    ...
    $query = "UPDATE choicerecordstucompany SET
    crsc_name='$crsc_name',
    mrsc_id='$mrsc_id' WHERE crsc_id = '$crsc_id'";
