...
<head>
  ...
  <title>ผลการแก้ไขข้อมูลหัวข้อรองสำหรับประเมินนักศึกษา &mdash; ระบบประเมินผลและติดตามการนิเทศงานนักศึกษา</title>
...
$mrs_id = $_POST['e'];
    ...
    $query = "UPDATE choicerecordstudent SET
    crs_name='$crs_name',
    mrs_id='$mrs_id' WHERE crs_id = '$crs_id'";
