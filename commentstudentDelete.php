                  ...
                  <div class="col-md-12">
                      <div class="card">
                        <div class="card-header" data-background-color="purple">
                            <h4 class="title">ลบข้อมูลความคิดเห็นเพิ่มเติม</h4>
                            <p class="category">คุณต้องการลบข้อมูลนี้ใช่หรือไม่ ?</p>
                        </div>
              <div class="modal-body">
                <form role="form" name="form" method="post" action="deletecommentstudentQuery.php" >
                  <div class="row">
                      <div class="col-lg-12">
