...
<body>
  <div class="modal-header">
    ...
    <h4 class="modal-title">เพิ่มหัวข้อรองอาจารย์ประเมินนักศึกษา</h4>
  </div>
  <div class="modal-body">
        <!-- /.box-header -->
        <!-- form start -->
        <form role="form" id="form" name="form" method="POST" action="addchoicestudentQuery.php">
          <div class="box-body">
            <div class="form-group label-floating has-feedback">
              <label>หัวข้อรองอาจารย์ประเมินนักศึกษา</label>
              <input type="text" name="crs_name" class="form-control css-require" placeholder="กรุณากรอกชื่อหัวข้อรอง">
            </div>
            <div class="form-group">
              <label>หัวข้อหลักอาจารย์ประเมินนักศึกษา</label>
              <select class="form-control" name="mrs_id" data-placeholder=""
              style="width: 100%;">
              <? $b = "SELECT * FROM mainrecordstudent" ;
