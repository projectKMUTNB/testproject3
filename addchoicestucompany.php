...
<body>
  <div class="modal-header">
    ...
    <h4 class="modal-title">เพิ่มหัวข้อรองนักศึกษาประเมินสถานประกอบการ</h4>
  </div>
  <div class="modal-body">
        <!-- /.box-header -->
        <!-- form start -->
        <form role="form" id="form" name="form" method="POST" action="addchoicestucompanyQuery.php">
          <div class="box-body">
            <div class="form-group label-floating has-feedback">
              <label>หัวข้อรองนักศึกษาประเมินสถานประกอบการ</label>
              <input type="text" name="crsc_name" class="form-control css-require" placeholder="กรุณากรอกชื่อหัวข้อรอง">
            </div>
            <div class="form-group">
              <label>หัวข้อหลักนักศึกษาประเมินสถานประกอบการ</label>
              <select class="form-control" name="mrsc_id" data-placeholder=""
              style="width: 100%;">
              <? $b = "SELECT * FROM mainrecordstucompany" ;
