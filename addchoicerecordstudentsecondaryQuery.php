...
<head>
  ...
  <title>ผลการบันทึกหัวข้อหลักสำหรับประเมินนักศึกษา &mdash; ระบบประเมินผลและติดตามการนิเทศงานนักศึกษา</title>
...
require_once('includesecondary/connect.php');
  ...
  $mrs_id = $_POST['mrs_id'];
      ...
      if($result){?>
                      ...
                      <div class="card-content table-responsive">
                          <table class="table table-hover" id="student">
                              <thead class="text-warning">
                                  <th>ชื่อหัวข้อรองสำหรับประเมินนักศึกษา</th>
        ...
        <?  echo "<META HTTP-EQUIV=\"REFRESH\" CONTENT=\"5; URL=mainrecordstudentsecondary.php\">";
      }else{
        echo "<script>alert(";
