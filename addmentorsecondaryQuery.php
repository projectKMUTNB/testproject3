...
<head>
  ...
  <title>ผลการบันทึกข้อมูลพี่เลี้ยง &mdash; ระบบประเมินผลและติดตามการนิเทศงานนักศึกษา</title>
...
<body>
  ...
  $mentor_password = md5($_POST['mentor_password']);
      ...
      if($result){?>
        ...
        <?  echo "<META HTTP-EQUIV=\"REFRESH\" CONTENT=\"3; URL=mentordatasecondary.php\">";
      }else{
        echo "<script>alert(";
