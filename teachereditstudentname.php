      ...
      <section class="content-header">
        ...
        <section class="content">
          <div class="box ">
            ...
            <!-- /.box-header -->
            <form id="form1" name="form1" method="get" action="teditstudentname.php">
            <div class="box-body">
              <div class="row">
                <div class="col-md-12">
                  <div class="form-group">
                    <label>เลือกชื่อนักศึกษาที่จะแก้ไข</label>
                    <select class="form-control select2" name="id" data-placeholder="กรอกชื่อหรือรหัสนักศึกษา"
                    style="width: 100%;">
            ...
            <div class="box-footer">
              <button type="submit" class="btn btn-success">ยืนยันเพื่อแก้ไข</button>
            </div>
          </form>
        </div>
      </section>
