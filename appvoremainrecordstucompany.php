...
<head>
    ...
    <title>หน้ายืนยันข้อมูลหัวข้อสำหรับนักศึกษาประเมินสถานประกอบการ &mdash; ระบบประเมินผลและติดตามการนิเทศงานนักศึกษา</title>
                      ...
                      <div class="col-lg-6 col-md-6 col-sm-6">
                          <div class="card card-stats">
                              ...
                              <div class="card-content">
                                  <p class="category">จำนวนหัวข้อสำหรับนักศึกษาประเมินสถานประกอบการรออนุมัติ
                                  </p>
                                  <h3 class="title">
                                    <? $a = "SELECT mrsc_id from mainrecordstucompany where approve_status = '2'";
                      ...
                      <div class="col-lg-6 col-md-6 col-sm-6">
                          <div class="card card-stats">
                              ...
                              <div class="card-content">
                                  ...
                                  <h3 class="title">
                                    <? $t = "SELECT crsc_id from choicerecordstucompany where approve_status = '2'";
                    ...
                    <div class="col-lg-12 col-md-12">
                        <div class="card">
                            <div class="card-header" data-background-color="orange">
                                ...
                                <p class="category">รายชื่อหัวข้อสำหรับนักศึกษาประเมินสถานประกอบการ</p>
                            </div>
                            <div class="card-content table-responsive">
                                <table class="table table-hover" id="mainrecordstucompany">
                                    ...
                                    <tbody>
                                      <?php $query = "SELECT * FROM mainrecordstucompany where approve_status = '2'";
                                      $g = 0;
                                      $a = 1;
                                      ...
                                      while ($b = mysqli_fetch_array($query)) { ?>
                                        <tr>
                                          ...
                                          <li><a href="appvoremainrecordstucompanyQuery.php?g=<?php echo $b[0]; ?>">ยืนยันข้อมูล</a></li>
                    ...
                    <div class="card">
                        ...
                        <div class="card-content table-responsive">
                            <table class="table table-hover" id="choicerecordstucompany">
                                ...
                                <tbody>
                                  <?php $query1 = "SELECT * FROM choicerecordstucompany where approve_status = '2'";
                                  $f = 0;
                                  $d = 1;
                                  ...
                                  while ($c = mysqli_fetch_array($query1)) { ?>
                                    <tr>
                                      ...
                                      <ul class="dropdown-menu ">
                                      <li><a href="appvorechoicerecordstucompanyQuery.php?f=<?php echo $c[0]; ?>">ยืนยันข้อมูล</a></li>
