...
<head>
  ...
  <title>ผลการแก้ไขข้อมูลอาจารย์ &mdash; ระบบประเมินผลและติดตามการนิเทศงานนักศึกษา</title>
...
$teacher_code = $_POST['g'];
    ...
    email_teacher='$email_teacher' WHERE teacher_code = '$teacher_code'";
                    ...
                    <div class="card-content table-responsive">
                        <table class="table table-hover" id="teacher">
                            <thead class="text-warning">
                                ...
                                <th>วิตำแหน่งทางวิชาการ</th>
                                <th>สาขาที่อาจารย์สังกัดอยู่</th>
                            </thead>
                            <tbody>
                                <tr>
