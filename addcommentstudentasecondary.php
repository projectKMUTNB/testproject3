...
<body>
 ...
 $(function(){
     ...
     var formCheckStatus = function(obj,status){
      ...
      <div id="commentstudentAdd" class="modal fade" role="dialog">
                          ...
                          <div class="col-md-12">
                              <div class="card">
                                <div class="card-header" data-background-color="purple">
                                    <h4 class="title">เพิ่มความคิดเห็นเพิ่มเติม</h4>
                                    <p class="category">เพิ่มความคิดเห็นเพิ่มเติม</p>
                                </div>
                                        <div class="col-lg-12">
                                            <form role="form" id="form" name="form" method="post" action="addcommentstudentasecondaryQuery.php">
                                              <div class="form-group label-floating has-feedback">
                                                <label class="control-label">ความคิดเห็นเพิ่มเติม</label>
                                                <textarea rows="4" name="commentstu_detail" class="form-control css-require"></textarea>
                                              </div>
                                              <div class="form-group label-floating has-feedback">
                                            ...
                                            <select class="form-control css-require" name="teacher_code" >
