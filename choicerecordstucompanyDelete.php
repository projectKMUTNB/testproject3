                  ...
                  <div class="col-md-12">
                      <div class="card">
                        <div class="card-header" data-background-color="red">
                            <h4 class="title">ลบข้อมูลหัวข้อรองสำหรับนักศึกษาประเมินสถานประกอบการ</h4>
                            <p class="category">คุณต้องการลบข้อมูลหัวข้อรองสำหรับนักศึกษาประเมินสถานประกอบการนี้ใช่หรือไม่ ?</p>
                        </div>
              <div class="modal-body">
                <form role="form" name="form" method="post" action="deletechoicerecordstucompanyQuery.php" >
                  <div class="row">
                      <div class="col-lg-12">
                      <div class="table-responsive">
                        ...
                        <tr><td>ชื่อหัวข้อรองสำหรับนักศึกษาประเมินสถานประกอบการ </td><td><?php echo $c[1]; ?></td></tr>
                        <tr><td>หัวข้อหลักสำหรับนักศึกษาประเมินสถานประกอบการ </td><td>
                        <? $b = "SELECT * FROM mainrecordstucompany where mrsc_id = $c[2]" ;
