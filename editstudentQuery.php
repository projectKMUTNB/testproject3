...
<head>
  ...
  <title>ผลการแก้ไขข้อมูลนักศึกษา &mdash; ระบบประเมินผลและติดตามการนิเทศงานนักศึกษา</title>
...
$student_code = $_POST['g'];

    $query = "UPDATE student SET
    student_name='$student_name',
    student_surname='$student_surname',
    student_department='$student_department',
    email_student='$email_student' WHERE student_code = '$student_code'";
    ...
    if($result){?>
      ...
      <?  echo "<META HTTP-EQUIV=\"REFRESH\" CONTENT=\"3; URL=studentdata.php\">";
    }else{
      echo "<script>alert(";
