                      ...
                      <div class="col-lg-3 col-md-6 col-sm-6">
                          <div class="card card-stats">
                              ...
                              <div class="card-content">
                                  ...
                                  <h3 class="title">
                                    <? $a = "SELECT mrcs_id from mainrecordcomstudent";
                     ...
                     <div class="col-lg-3 col-md-6 col-sm-6">
                          <div class="card card-stats">
                              ...
                              <div class="card-content">
                                  ...
                                  <h3 class="title">
                                    <?  $t = "SELECT crcs_id from choicerecordcomstudent";
                            ...
                            <div class="card-content table-responsive">
                              ...
                              <i class="material-icons">note</i> เพิ่มรายชื่อหัวข้อหลักสำหรับสถานประกอบการประเมินนักศึกษา</button>
                                <table class="table table-hover" id="mainrecordcomstudent">
                                    ...
                                    <tbody>
                                      <?php $query = "SELECT * FROM mainrecordcomstudent";
                                      $g = 0;
                                      $a = 1;
                        ...
                        <div class="card-content table-responsive">
                          ...
                          <i class="material-icons">note</i> เพิ่มรายชื่อหัวข้อรองสำหรับสถานประกอบการประเมินนักศึกษา</button>
                            <table class="table table-hover" id="choicerecordcomstudent">
                                ...
                                <tbody>
                                  <?php $query1 = "SELECT * FROM mainrecordcomstudent,choicerecordcomstudent where mainrecordcomstudent.mrcs_id = choicerecordcomstudent.mrcs_id ";
                                 $f = 0;
                                 $d = 1;
...
<!-- Modal Bootstrap-->
<?php include('addmainrecordcomstudentsecondary.php'); ?>

<?php include('addchoicerecordcomstudentsecondary.php'); ?>
