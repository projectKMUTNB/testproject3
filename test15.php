      ...
      <section class="content-header">
        ...
        <form class="form-horizontal" method="post" action="" >
          <div class="box-body">
            ...
            <div class="form-group">
              <label class="col-sm-1 control-label">ระยะทาง :</label>
              <div class="col-sm-10">
                <input name="distance_text" type="text" id="distance_text" class="form-control" placeholder="แสดงระยะทาง" disabled/>
              </div>
            </div>
            <div class="form-group">
              <label class="col-sm-1 control-label">ระยะเวลาที่ถึง :</label>
              <div class="col-sm-10">
...
$(function(){
    ...
    $("<script/>", {
      "type": "text/javascript",
       ...
       src: "//maps.google.com/maps/api/js?v=3.2&sensor=false&key=AIzaSyDrLP1L6JIe1HTeANOx8UV5n31NytuHWnw&sensor=false&language=th&callback=initialize"
