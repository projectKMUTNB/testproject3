                                    ...
                                    <tbody>
                                      ...
                                      while ($b = mysqli_fetch_array($query)) { ?>
                                        <tr>
                                          ...
                                          <li><a href="editcommentstudenta.php?g=<?php echo $b[0]; ?>" data-toggle="modal" data-target="#editcomment">แก้ไขข้อมูล</a></li>
                                          <li><a href="commentstudentDelete.php?g=<?php echo $b[0]; ?>" data-toggle="modal" data-target="#commentDelete">ลบข้อมูล</a></li>
                                          </ul>
                                        </td>
                                          <?php $g++; } ?>
                                      </tr>
...
<?php include('addcommentstudenta.php'); ?>
             ...
             <div class="modal fade" id="commentDelete" tabindex="-1" role="dialog" aria-labelledby="myModalLabel">
               <div class="modal-dialog" role="document">
                 <div class="modal-content">
                 </div>
               </div>
            ...
            <script type="text/javascript">
            $(document).ready(function() {
                $('#commentDelete').on('hidden.bs.modal', function () {
                      $(this).removeData('bs.modal');
                });
            });
            </script>
