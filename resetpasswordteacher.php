				...
				<div class="card-wrapper">
					...
					<div class="card fat">
						<div class="card-body">
							...
							<form action="resetpasswordteacherQuery.php" enctype="multipart/form-data" method="post" role="form" name="formRegister" onSubmit="JavaScript:return fncSubmit('formRegister');">
...
function fncSubmit(frm)
	{
		if(document.forms[frm].teacherpassword.value != document.forms[frm].teacherpasswordag.value){
