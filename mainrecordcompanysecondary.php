                      ...
                      <div class="col-lg-3 col-md-6 col-sm-6">
                          <div class="card card-stats">
                              ...
                              <div class="card-content">
                                  ...
                                  <h3 class="title">
                                    <? $a = "SELECT mrc_id from mainrecordcompany";
                      ...
                      <div class="col-lg-3 col-md-6 col-sm-6">
                          <div class="card card-stats">
                              ...
                              <div class="card-content">
                                  ...
                                  <h3 class="title">
                                    <? $t = "SELECT mrc_id from choicerecordcompany";
                            ...
                            <div class="card-content table-responsive">
                              ...
                              <i class="material-icons">note</i> เพิ่มรายชื่อหัวข้อหลักสำหรับประเมินสถานประกอบการ</button>
                                <table class="table table-hover" id="mainrecordcompany">
                                    ...
                                    <tbody>
                                      <?php $query = "SELECT * FROM mainrecordcompany";
                                      $g = 0;
                                      $a = 1;
                        ...
                        <div class="card-content table-responsive">
                          ...
                          <i class="material-icons">note</i> เพิ่มรายชื่อหัวข้อรองสำหรับประเมินสถานประกอบการ</button>
                            <table class="table table-hover" id="choicerecordcompany">
                                ...
                                <tbody>
                                  <?php $query1 = "SELECT * FROM mainrecordcompany,choicerecordcompany where mainrecordcompany.mrc_id = choicerecordcompany.mrc_id ";
                                  $f = 0;
                                  $d = 1;
...
<!-- Modal Bootstrap-->
<?php include('addmainrecordcompanysecondary.php'); ?>
<?php include('addchoicerecordcompanysecondary.php'); ?>
