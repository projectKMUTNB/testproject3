...
$query3 =  "SELECT score_tc FROM trecodecompanyevaluation WHERE student_code='$student_code'";
$query3 = mysqli_query($conn,$query3);

$query = "SELECT * FROM mainrecordcompany";
...
while ($m=mysqli_fetch_array($query))
{
    ...
    $a++;
    $query1 = "SELECT crc_name FROM choicerecordcompany where mrc_id = $a";
