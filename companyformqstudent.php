...
<body>
      ...
      <div class="modal-body">
        <div class="box-body table-responsive no-padding">
            <form role="form" id="form" name="form" method="POST" action="companyformqstudentQuery.php">
              <table class="table table-hover">
               <tbody>
                ...
                <?php
                $i=0;
                $query = "SELECT * FROM mainrecordcomstudent where approve_status ='1'";
                $query = mysqli_query($conn,$query);
                $i=1;
                while ($m=mysqli_fetch_array($query))
                {
                  $a++;
                  $query1 = "SELECT crcs_name FROM choicerecordcomstudent where mrcs_id = $a and approve_status ='1'";
                    ...
                    ?></td>
                      ...
                      {?>
                        <p class="question">
                          ...
                          <div class="radio">
                          <td align="center"><input name="radio_<?php echo $i?>" class="css-require" type="radio" value="4"></td>
                          <td align="center"><input name="radio_<?php echo $i?>" class="css-require" type="radio" value="3"></td>
                          <td align="center"><input name="radio_<?php echo $i?>" class="css-require" type="radio" value="2"></td>
                          <td align="center"><input name="radio_<?php echo $i?>" class="css-require" type="radio" value="1"></td>
                          <td align="center"><input name="radio_<?php echo $i?>" class="css-require" type="radio" value="0"></td>
                        </div>
                        </div>
                          <p>
                            <? $i++; }?>
          ...
          <div class="form-group label-floating has-feedback">
            ...
            <textarea class="form-control css-require" rows="4" placeholder="กรอกความคิดเห็นเพิ่มเติม" name="ccstudent_detail"></textarea>
          </div>
          <input type="hidden" name="Sc" value="<?echo $student_code?>">
          <input type="hidden" name="Mc" value="<?echo $mentor_code?>">
