...
<head>
  ...
  <title>จัดการหัวข้ออาจารย์ประเมินสถานประกอบการ &mdash; ระบบประเมินผลและติดตามการนิเทศงานนักศึกษา</title>
    ...
    <div class="content-wrapper">
      <section class="content-header">
        ...
        <ol class="breadcrumb">
          ...
          <li class="active"><i class="fa fa-file"></i></li> หัวข้ออาจารย์ประเมินสถานประกอบการ
        </ol>
      </section>
        <section class="content">
            <div class="box box-success">
                <div class="box-header">
                  <h3 class="box-title">หัวข้อหลักอาจารย์ประเมินสถานประกอบการ</h3>
                </div>
                <div class="box-body">
                  <div class="dropdown pull-left">
                  <a href="addmaincompany.php"
                  class="btn btn-success pull-left" data-toggle="modal" data-target="#normal">
                  <i class="glyphicon glyphicon-list-alt"></i> เพิ่มหัวข้อหลักอาจารย์ประเมินสถานประกอบการ
                  </a>
                  &nbsp;
                  </div>
                  </div>
                    <!-- /.box-header -->
                    <div class="box-body">
                      <table id="company1" class="table table-bordered table-striped">
                        <thead>
                        <tr>
                          <th>ลำดับ</th>
                        ...
                        <tbody>
                          <?php $query = "SELECT * FROM mainrecordcompany where approve_status = '1' order by mrc_id asc";
                          $g = 0;
                          $a = 1;
        ...
        <section class="content">
            <div class="box box-success">
                <div class="box-header">
                  <h3 class="box-title">หัวข้อรองอาจารย์ประเมินสถานประกอบการ</h3>
                </div>
                <div class="box-body">
                  <div class="dropdown pull-left">
                  <a href="addchoicecompany.php"
                  class="btn btn-success pull-left" data-toggle="modal" data-target="#normal1">
                  <i class="glyphicon glyphicon-list-alt"></i> เพิ่มหัวข้อรองอาจารย์ประเมินสถานประกอบการ
                  </a>
                  &nbsp;
                  </div>
                  </div>
                    ...
                    <div class="box-body">
                      <table id="company" class="table table-bordered table-striped">
                        ...
                        <tbody>
                          <?php $query = "SELECT * FROM choicerecordcompany where approve_status = '1' order by crc_id asc";
                          $g = 0;
                          $a = 1;
                          $query = mysqli_query($conn,$query);
                          while ($b = mysqli_fetch_array($query)) { ?>
