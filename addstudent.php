                          ...
                          <div class="col-md-12">
                              <div class="card">
                                <div class="card-header" data-background-color="orange">
                                    <h4 class="title">เพิ่มข้อมูลนักศึกษา</h4>
                                    <p class="category">เพิ่มข้อมูลนักศึกษาที่ฝึกงาน</p>
                                </div>
                                        <div class="col-lg-12">
                                            <form role="form" id="form" name="form" method="post" action="addstudentQuery.php">
                                              <div class="form-group label-floating has-feedback">
                                                <label class="control-label">รหัสนักศึกษา</label>
                                                <input type="text" name="student_code" maxlength="13" class="form-control css-require" onKeyUp="if(isNaN(this.value)){ alert('กรุณากรอกตัวเลข'); this.value='';}" >
                                              </div>
                                              <div class="form-group label-floating has-feedback">
                                                <label class="control-label">ชื่อนักศึกษา</label>
                                                <input type="text" name="student_name" class="form-control css-require">
                                              </div>
                                              <div class="form-group label-floating has-feedback">
                                                <label class="control-label">นามสกุลนักศึกษา</label>
                                                <input type="text" name="student_surname" class="form-control css-require">
                                              </div>
                                              <div class="form-group label-floating has-feedback">
                                                <label class="control-label">สาขาที่นักศึกษาสังกัดอยู่</label>
                                                <input type="text" name="student_department" class="form-control css-require">
                                              </div>
                                              <div class="form-group label-floating has-feedback">
                                                <label class="control-label">Email นักศึกษา</label>
                                                <input type="text" name="email_student" class="form-control css-require">
                                              </div>
                                              <button type="submit"  id="submit" name="submit"
                                              class="btn btn-success btn-round has-feedback" onclick="myFunction()">ยืนยันข้อมูล</button>
