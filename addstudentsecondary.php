                              ...
                              <div class="card">
                                <div class="card-header" data-background-color="orange">
                                    ...
                                    <p class="category">เพิ่มข้อมูลนักศึกษาที่ฝึกงาน</p>
                                        ...
                                        <div class="col-lg-12">
                                            <form role="form" id="form" name="form" method="post" action="addstudentsecondaryQuery.php">
                                              <div class="form-group label-floating has-feedback">
                                                <label class="control-label">รหัสนักศึกษา</label>
                                                <input type="text" name="student_code" class="form-control css-require" onKeyUp="if(isNaN(this.value)){ alert('กรุณากรอกตัวเลข'); this.value='';}">
                                              </div>
                                              <div class="form-group label-floating has-feedback">
