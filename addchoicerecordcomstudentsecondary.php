...
<body>
 ...
 $(function(){
     ...
     var formCheckStatus = function(obj,status){
      ...
      <div id="choicerecordcomstudentAdd" class="modal fade" role="dialog">
                          ...
                          <div class="col-md-12">
                              <div class="card">
                                <div class="card-header" data-background-color="red">
                                    <h4 class="title">เพิ่มข้อมูลหัวข้อรองสำหรับสถานประกอบประเมินนักศึกษา</h4>
                                    <p class="category">เพิ่มข้อมูลหัวข้อรองสำหรับสถานประกอบประเมินนักศึกษา</p>
                                </div>
                                        <div class="col-lg-12">
                                            <form role="form" id="form1" name="form1" method="post" action="addchoicerecordcomstudentsecondaryQuery.php">
                                              <div class="form-group label-floating has-feedback">
                                                <label class="control-label">ชื่อหัวข้อรองสำหรับสถานประกอบประเมินนักศึกษา</label>
                                                <input type="text" name="crcs_name" class="form-control css-require">
                                              </div>
                                              <div class="form-group label-floating has-feedback">
                                              <label>หัวข้อหลักสำหรับสถานประกอบประเมินนักศึกษา</label>
                                              <select class="form-control css-require" name="mrcs_id" >
