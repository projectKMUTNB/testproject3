                  ...
                  <div class="col-md-12">
                      <div class="card">
                        <div class="card-header" data-background-color="red">
                            <h4 class="title">ลบข้อมูลค่าเดินทาง</h4>
                            <p class="category">คุณต้องการลบข้อมูลค่าเดินทางนี้ใช่หรือไม่ ?</p>
                        </div>
              <div class="modal-body">
                <form role="form" name="form" method="post" action="deletetravelexpense.php" >
                  <div class="row">
                      <div class="col-lg-12">
                      <div class="table-responsive">
                        ...
                        <tr><th>ค่าเดินทาง </th><td><?php echo $c[1]."บาท/กิโลเมตร"; ?></td></tr>
                        </table>
