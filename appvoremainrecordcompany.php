...
<head>
    ...
    <title>หน้ายืนยันข้อมูลหัวข้อสำหรับประเมินสถานประกอบการ &mdash; ระบบประเมินผลและติดตามการนิเทศงานนักศึกษา</title>
                      ...
                      <div class="col-lg-6 col-md-6 col-sm-6">
                          <div class="card card-stats">
                              ...
                              <div class="card-content">
                                  <p class="category">จำนวนหัวข้อสำหรับประเมินสถานประกอบการรออนุมัติ
                                  </p>
                                  <h3 class="title">
                      ...
                      <div class="col-lg-6 col-md-6 col-sm-6">
                          <div class="card card-stats">
                              ...
                              <div class="card-content">
                                  ...
                                  <h3 class="title">
                                    <? $t = "SELECT crc_id from choicerecordcompany where approve_status = '2'";
                        ...
                        <div class="card">
                            ...
                            <div class="card-content table-responsive">
                                <table class="table table-hover" id="mainrecordcompany">
                                    ...
                                    <tbody>
                                      <?php $query = "SELECT * FROM mainrecordcompany where approve_status = '2'";
                                      $g = 0;
                                      $a = 1;
                                      ...
                                      while ($b = mysqli_fetch_array($query)) { ?>
                                        <tr>
                                          ...
                                          <li><a href="appvoremainrecordcompanyQuery.php?g=<?php echo $b[0]; ?>">ยืนยันข้อมูล</a></li>
                    ...
                    <div class="card">
                        ...
                        <div class="card-content table-responsive">
                            <table class="table table-hover" id="choicerecordcompany">
                                ...
                                <tbody>
                                  <?php $query1 = "SELECT * FROM choicerecordcompany where approve_status = '2'";
                                  $f = 0;
                                  $d = 1;
                                  ...
                                  while ($c = mysqli_fetch_array($query1)) { ?>
                                    <tr>
                                      ...
                                      <ul class="dropdown-menu ">
                                      <li><a href="appvorechoicerecordcompanyQuery.php?f=<?php echo $c[0]; ?>">ยืนยันข้อมูล</a></li>
