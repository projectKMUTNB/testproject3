...
<body>
 ...
 $(function(){
     ...
     var formCheckStatus = function(obj,status){
      ...
      <div id="mainrecordstudentAdd" class="modal fade" role="dialog">
                          ...
                          <div class="col-md-12">
                              <div class="card">
                                <div class="card-header" data-background-color="orange">
                                    <h4 class="title">เพิ่มข้อมูลหัวข้อหลักสำหรับประเมินนักศึกษา</h4>
                                    <p class="category">เพิ่มข้อมูลหัวข้อหลักสำหรับประเมินนักศึกษาที่อาจารย์ไปนิเทศงานนักศึกษา</p>
                                </div>
                                        <div class="col-lg-12">
                                            <form role="form" id="form" name="form" method="post" action="addmainrecordstudentsecondaryQuery.php">
                                              <div class="form-group label-floating has-feedback">
                                                <label class="control-label">ชื่อหัวข้อหลักสำหรับประเมินนักศึกษา</label>
                                                <input type="text" name="mrs_name" class="form-control css-require">
                                              </div>
