...
<head>
  ...
  <title>ผลการบันทึกข้อมูลสถานประกอบการ &mdash; ระบบประเมินผลและติดตามการนิเทศงานนักศึกษา</title>
...
<body>
  ...
  $company_tel = $_POST['company_tel'];
      ...
      if($result){?>
        ...
        <?  echo "<META HTTP-EQUIV=\"REFRESH\" CONTENT=\"3; URL=companydatasecondary.php\">";
      }else{
        echo "<script>alert(";
