                      ...
                      <div class="col-lg-3 col-md-6 col-sm-6">
                          <div class="card card-stats">
                              ...
                              <div class="card-content">
                                  ...
                                  <h3 class="title">
                                    <? $a = "SELECT mrsc_id from mainrecordstucompany";
                     ...
                     <div class="col-lg-3 col-md-6 col-sm-6">
                          <div class="card card-stats">
                              ...
                              <div class="card-content">
                                  ...
                                  <h3 class="title">
                                    <?  $t = "SELECT crsc_id from choicerecordstucompany";
                            ...
                            <div class="card-content table-responsive">
                              ...
                              <i class="material-icons">note</i> เพิ่มรายชื่อหัวข้อหลักสำหรับประเมินสถานประกอบการ</button>
                                <table class="table table-hover" id="mainrecordstucompany">
                                    ...
                                    <tbody>
                                      <?php $query = "SELECT * FROM mainrecordstucompany";
                                      $g = 0;
                                      $a = 1;
                        ...
                        <div class="card-content table-responsive">
                          ...
                          <i class="material-icons">note</i> เพิ่มรายชื่อหัวข้อรองสำหรับประเมินสถานประกอบการ</button>
                            <table class="table table-hover" id="choicerecordstucompany">
                                ...
                                <tbody>
                                  <?php $query1 = "SELECT * FROM mainrecordstucompany,choicerecordstucompany where mainrecordstucompany.mrsc_id = choicerecordstucompany.mrsc_id ";
                                 $f = 0;
                                 $d = 1;
...
<!-- Modal Bootstrap-->
<?php include('addmainrecordstucompanysecondary.php'); ?>

<?php include('addchoicerecordstucompanysecondary.php'); ?>
