           ...
           <ul class="nav navbar-nav navbar-right">
               <li>
                ...
                <li class="dropdown">
                    ...
                    คุณ <? echo $_SESSION['teacher_name']; ?>
                    <p class="hidden-lg hidden-md">ข้อมูลส่วนตัว</p>
                    </a>
                    <ul class="dropdown-menu">
                      <li>
                          <a href="#"><i class="material-icons">account_box</i> แก้ไข้ข้อมูล</a>
                      </li>
                      <li>
...
<a href="index2.html" class="logo">
  ...
  <span class="logo-lg">ระบบติดตามและประเมินผลการนิเทศนักศึกษา<b></b></span>
</a>
