...
<h4 class="panel-title">
  ...
  <a href="?id=<?php echo $row['student_code'];?>"
    name="button" class="btn btn-warning btn-xs pull-right">
    <i class="material-icons">description</i> จัดการข้อมูล
  </a>
</h4>
</div>
...
<?  $c = "SELECT * FROM company where company_code = $company_code" ;
...
<p><b>สถานประกอบการชื่อ</b> : <?php echo $c[1];?></p>
</div>
</div>
<? } ?>
<? } ?>
<?php } ?>
<center>
<button class="btn btn-success" data-toggle="modal" data-target="#addselectstudentcom">
<i class="material-icons">assignment_ind</i> เลือกนักศึกษาที่ฝึกงาน
</button>
</center>
</div>
</div>
  ...
  <?php include('addselectstudentcom.php'); ?>
<!--   Core JS Files   -->
