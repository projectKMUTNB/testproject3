                  ...
                  <div class="col-md-12">
                      <div class="card">
                        <div class="card-header" data-background-color="purple">
                            <h4 class="title">ลบข้อมูลหัวข้อหลักสำหรับสถานประกอบการประเมินนักศึกษา</h4>
                            <p class="category">คุณต้องการลบข้อมูลหัวข้อหลักสำหรับสถานประกอบการประเมินนักศึกษานี้ใช่หรือไม่ ?</p>
                        </div>
              <div class="modal-body">
                <form role="form" name="form" method="post" action="deletemainrecordcomstudentQuery.php" >
                  <div class="row">
                      <div class="col-lg-12">
                      <div class="table-responsive">
                        ...
                        <tr><th>ชื่อหัวข้อหลักสำหรับสถานประกอบการประเมินนักศึกษา </th><td><?php echo $c[1]; ?></td></tr>
                        </table>
