                                      ...
                                      <tbody>
                                        ...
                                        while ($b = mysqli_fetch_array($query)) { ?>
                                          <tr>
                                            ...
                                            <li><a href="editcompany.php?g=<?php echo $b[0]; ?>" data-toggle="modal" data-target="#editcompany">แก้ไขข้อมูล</a></li>
                                            <li><a href="companyDelete.php?g=<?php echo $b[0]; ?>" data-toggle="modal" data-target="#companyDelete">ลบข้อมูล</a></li>
...
<?php include('addcompany.php'); ?>
             ...
             <div class="modal fade" id="showcompany" tabindex="-1" role="dialog" aria-labelledby="myModalLabel">
               <div class="modal-dialog" role="document">
                 <div class="modal-content">
                 </div>
               </div>
            ...
            <script type="text/javascript">
            $(document).ready(function() {
                $('#showcompany').on('hidden.bs.modal', function () {
                      $(this).removeData('bs.modal');
                });
            });
            </script>
