...
<body>
 ...
 $(function(){
     ...
     var formCheckStatus = function(obj,status){
      ...
      <div id="choicerecordcompanyAdd" class="modal fade" role="dialog">
                          ...
                          <div class="col-md-12">
                              <div class="card">
                                <div class="card-header" data-background-color="red">
                                    <h4 class="title">เพิ่มข้อมูลหัวข้อรองสำหรับประเมินสถานประกอบการ</h4>
                                    <p class="category">เพิ่มข้อมูลหัวข้อรองสำหรับประเมินสถานประกอบการที่อาจารย์ไปนิเทศงานนักศึกษา</p>
                                </div>
                                        <div class="col-lg-12">
                                            <form role="form" id="form1" name="form1" method="post" action="addchoicerecordcompanysecondaryQuery.php">
                                              <div class="form-group label-floating has-feedback">
                                                <label class="control-label">ชื่อหัวข้อรองสำหรับประเมินสถานประกอบการ</label>
                                                <input type="text" name="crc_name" class="form-control css-require">
                                              </div>
                                              <div class="form-group label-floating has-feedback">
                                              <label>หัวข้อหลักสำหรับประเมินสถานประกอบการที่อาจารย์ไปนิเทศงานนักศึกษา</label>
                                              <select class="form-control css-require" name="mrc_id" >
                                                <? $b = "SELECT * FROM mainrecordcompany where mrc_id = mrc_id" ;
