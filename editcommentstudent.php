...
$a = "SELECT * FROM commentstudent where student_code = $student_code" ;
...
<head>
  ...
  <title>แก้ไขความคิดเห็นเพิ่มเติมของนักศึกษา &mdash; ระบบประเมินผลและติดตามการนิเทศงานนักศึกษา</title>
  ...
  <div class="wrapper">
    ...
    <div class="content-wrapper">
      <section class="content-header">
        <h1>
          แก้ไขความคิดเห็นเพิ่มเติมของนักศึกษา
          <small></small>
        </h1>
        <ol class="breadcrumb">
          ...
          <li class="active"><i class="fa fa-commenting-o"></i></li> แก้ไขความคิดเห็นเพิ่มเติมของนักศึกษา
        </ol>
      </section>
    ...
    <div class="col-md-8">
      ...
      <div class="box box-success">
        <div class="box-header with-border">
          <h3 class="box-title">แก้ไขความคิดเห็นเพิ่มเติมของนักศึกษา</h3>
        </div>
        <!-- /.box-header -->
        <!-- form start -->
        <form role="form" id="form" name="form" method="POST" action="editcommentstudentQuery.php">
          <div class="box-body">
            <div class="form-group">
              <label>ความคิดเห็นเพิ่มเติมของนักศึกษา</label>
              <input type="text" value="<? echo $b[0].' '.$b[1].' '.$b[2]; ?>" class="form-control" disabled>
            </div>
            <div class="form-group">
              <label>แก้ไขความเห็นเพิ่มเติม</label>
              <textarea class="form-control" rows="4" name="commentstu_detail"><? echo $a[1];?></textarea>
            </div>
          </div>
          <!-- /.box-body -->
            <div class="box-footer">
              <input type="hidden" name="commentstu_id" value="<? echo $a[0];?>">
