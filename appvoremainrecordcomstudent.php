...
<head>
    ...
    <title>หน้ายืนยันข้อมูลหัวข้อสำหรับสถานประกอบการประเมินนักศึกษา &mdash; ระบบประเมินผลและติดตามการนิเทศงานนักศึกษา</title>
            ...
            <div class="content">
                <div class="container-fluid">
                    <div class="row">
                      <div class="col-lg-6 col-md-6 col-sm-6">
                          <div class="card card-stats">
                              ...
                              <div class="card-content">
                                  <p class="category">จำนวนหัวข้อสำหรับสถานประกอบการประเมินนักศึกษาการรออนุมัติ
                                  </p>
                                  <h3 class="title">
                                    <? $a = "SELECT mrcs_id from mainrecordcomstudent where approve_status = '2'";
                      ...
                      <div class="col-lg-6 col-md-6 col-sm-6">
                          <div class="card card-stats">
                              ...
                              <div class="card-content">
                                  <p class="category">จำนวนหัวข้อสำหรับนักศึกษาสถานประกอบการประเมินนักศึกษารออนุมัติ
                                  </p>
                                  <h3 class="title">
                                    <? $t = "SELECT crcs_id from choicerecordcomstudent where approve_status = '2'";
                    ...
                    <div class="col-lg-12 col-md-12">
                        <div class="card">
                            <div class="card-header" data-background-color="orange">
                                <h4 class="title">รายชื่อหัวข้อสำหรับนักศึกษาสถานประกอบการประเมินนักศึกษา</h4>
                                <p class="category">รายชื่อหัวข้อสำหรับนักศึกษาสถานประกอบการประเมินนักศึกษา</p>
                            </div>
                            <div class="card-content table-responsive">
                                <table class="table table-hover" id="mainrecordcomstudent">
                                    <thead class="text-warning">
                                        <th>ลำดับ</th>
                                        <th>หัวข้อสำหรับนักศึกษาสถานประกอบการประเมินนักศึกษา</th>
                                        <th>ยืนยันข้อมูล/ลบข้อมูล</th>
                                    </thead>
                                    <tbody>
                                      <?php $query = "SELECT * FROM mainrecordcomstudent where approve_status = '2'";
                                      $g = 0;
                                      $a = 1;
                                      ...
                                      while ($b = mysqli_fetch_array($query)) { ?>
                                        <tr>
                                          ...
                                          <li><a href="appvoremainrecordcomstudentQuery.php?g=<?php echo $b[0]; ?>">ยืนยันข้อมูล</a></li>
                    ...
                    <div class="card">
                        ...
                        <div class="card-content table-responsive">
                            <table class="table table-hover" id="choicerecordcomstudent">
                                ...
                                <tbody>
                                  <?php $query1 = "SELECT * FROM choicerecordcomstudent where approve_status = '2'";
                                  $f = 0;
                                  $d = 1;
                                  ...
                                  while ($c = mysqli_fetch_array($query1)) { ?>
                                    <tr>
                                      ...
                                      <ul class="dropdown-menu ">
                                      <li><a href="appvorechoicerecordcomstudentQuery.php?f=<?php echo $c[0]; ?>">ยืนยันข้อมูล</a></li>
