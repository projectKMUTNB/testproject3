...
<body>
 ...
 $(function(){
     ...
     var formCheckStatus = function(obj,status){
      ...
      <div id="mainrecordcomstudentAdd" class="modal fade" role="dialog">
                          ...
                          <div class="col-md-12">
                              <div class="card">
                                <div class="card-header" data-background-color="purple">
                                    <h4 class="title">เพิ่มข้อมูลหัวข้อหลักสำหรับสถานประกอบการประเมินนักศึกษา</h4>
                                    <p class="category">เพิ่มข้อมูลหัวข้อหลักสำหรับสถานประกอบการประเมินนักศึกษา</p>
                                </div>
                                        <div class="col-lg-12">
                                            <form role="form" id="form" name="form" method="post" action="addmainrecordcomstudentsecondaryQuery.php">
                                              <div class="form-group label-floating has-feedback">
                                                <label class="control-label">ชื่อหัวข้อหลักสำหรับสถานประกอบการประเมินนักศึกษา</label>
                                                <input type="text" name="mrcs_name" class="form-control css-require">
                                              </div>
