...
<body>
  <div class="modal-header">
    ...
    <h4 class="modal-title">เพิ่มหัวข้อหลักนักศึกษาประเมินสถานประกอบการ</h4>
  </div>
  <div class="modal-body">
        <!-- /.box-header -->
        <!-- form start -->
        <form role="form" id="form" name="form" method="POST" action="addmainstucompanyQuery.php">
          <div class="box-body">
            <div class="form-group label-floating has-feedback">
              <label>หัวข้อหลักนักศึกษาประเมินสถานประกอบการ</label>
              <input type="text" name="mrsc_name" class="form-control css-require" placeholder="กรุณากรอกชื่อหัวข้อหลัก">
            </div>
          </div>
          <!-- /.box-body -->
