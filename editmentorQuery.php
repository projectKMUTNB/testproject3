...
<head>
  ...
  <title>ผลการแก้ไขข้อมูลพี่เลี้ยง &mdash; ระบบประเมินผลและติดตามการนิเทศงานนักศึกษา</title>
...
$mentor_code = $_POST['g'];
    ...
    email_mentor='$email_mentor' WHERE mentor_code = '$mentor_code'";
